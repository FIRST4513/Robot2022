 ...
 *
 */
public class autoBlueDoubleCenterCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoBlueDoubleCenterCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
