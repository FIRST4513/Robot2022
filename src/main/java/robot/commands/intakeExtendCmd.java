 ...
 *
 */
public class intakeExtendCmd extends CommandBase {
    ...
    public intakeExtendCmd(payloadSubSys subsystem) {
    ...
    public void execute() {
        ...
        m_payloadSubSys.intakeExtend();

        m_payloadSubSys.intakeRollerMotorStart(Constants.intake_speed);
        m_payloadSubSys.handoffMotorStart(Constants.handoff_speed);
        m_payloadSubSys.shooterMotorStart(0.5);
    }
