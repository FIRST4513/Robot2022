 ...
 *
 */
public class autoBlueDoubleRightCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoBlueDoubleRightCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
