 ...
 *
 */
public class autoShootOnlyCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoShootOnlyCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
