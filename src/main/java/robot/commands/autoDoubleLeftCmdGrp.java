 ...
 *
 */
public class autoDoubleLeftCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoDoubleLeftCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
