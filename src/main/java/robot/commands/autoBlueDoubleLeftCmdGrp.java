 ...
 *
 */
public class autoBlueDoubleLeftCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoBlueDoubleLeftCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
