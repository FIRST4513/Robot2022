 ...
 *
 */
public class autoBlueSingleCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoBlueSingleCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
