 ...
 *
 */
public class autoRedDoubleCenterCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoRedDoubleCenterCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
