 ...
 *
 */
public class autoRedDoubleLeftCmdGrp extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public autoRedDoubleLeftCmdGrp(drivetrainSubSys drivetrainSubSys, payloadSubSys payloadSubSys){
