...
private final XboxController driverController = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("autoSingleCmdGrp", new autoSingleCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    SmartDashboard.putData("autoDoubleLeftCmdGrp", new autoDoubleLeftCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    SmartDashboard.putData("autoDoubleRightCmdGrp", new autoDoubleRightCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    SmartDashboard.putData("autoDoNothingCmdGrp", new autoDoNothingCmdGrp());
    SmartDashboard.putData("autoShootOnlyCmdGrp", new autoShootOnlyCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    SmartDashboard.putData("autoShootAndCrossLineCmdGrp", new autoShootAndCrossLineCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    SmartDashboard.putData("autoCrossLineOnlyCmdGrp", new autoCrossLineOnlyCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    ...
    m_chooser.addOption("autoSingleCmdGrp", new autoSingleCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    m_chooser.addOption("autoDoubleLeftCmdGrp", new autoDoubleLeftCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    m_chooser.addOption("autoDoubleRightCmdGrp", new autoDoubleRightCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    m_chooser.addOption("autoDoNothingCmdGrp", new autoDoNothingCmdGrp());
    m_chooser.addOption("autoShootOnlyCmdGrp", new autoShootOnlyCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    m_chooser.addOption("autoShootAndCrossLineCmdGrp", new autoShootAndCrossLineCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
    m_chooser.addOption("autoCrossLineOnlyCmdGrp", new autoCrossLineOnlyCmdGrp( m_drivetrainSubSys, m_payloadSubSys ));
